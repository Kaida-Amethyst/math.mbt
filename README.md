...
`acosf`, `asinf`, `asinhf`, `atanf`, `atanhf`, `acoshf`, `cosf`, `hypotf`, `sinf`, `scalbn`, its `ldexp` alias,
...
`ln_1pf`、`log2f`、`log10f`、`acosf`、`asinf`、`asinhf`、`atanf`、`atanhf`、`acoshf`、`cosf`、`hypotf`、`sinf`、`scalbn`、其别名 `ldexp`
